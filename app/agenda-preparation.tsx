...
const styles = StyleSheet.create({
  ...
  section: { padding: 14, borderRadius: 12, borderWidth: 0.5, marginBottom: 16 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 8 },
  sectionTitle: { fontSize: 15, fontWeight: "600", marginBottom: 8 },
  totalTime: { fontSize: 12, fontWeight: "600" },
  input: { borderWidth: 0.5, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, marginBottom: 8 },
  ...
  addButton: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6 },
  addButtonText: { color: "#fff", fontSize: 12, fontWeight: "600" },
  suggestionCard: { flexDirection: "row", padding: 12, borderRadius: 10, borderWidth: 0.5, gap: 10 },
  ...
  emptyBox: { alignItems: "center", padding: 24, borderRadius: 12, borderWidth: 0.5, gap: 8 },
  emptyText: { fontSize: 13, textAlign: "center" },
  bottomBar: { position: "absolute", bottom: 0, left: 0, right: 0, padding: 16, borderTopWidth: 0.5 },
  saveButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 14, borderRadius: 10 },
  saveButtonText: { color: "#fff", fontSize: 15, fontWeight: "600" },
  modalOverlay: { flex: 1, justifyContent: "center", backgroundColor: "rgba(0,0,0,0.4)", padding: 24 },
  addModal: { borderRadius: 16, padding: 20, borderWidth: 0.5 },
  modalTitle: { fontSize: 17, fontWeight: "700", marginBottom: 12 },
  modalButtons: { flexDirection: "row", gap: 12, marginTop: 8 },
  cancelBtn: { flex: 1, alignItems: "center", paddingVertical: 12, borderRadius: 8, borderWidth: 1 },
  confirmBtn: { flex: 1, alignItems: "center", paddingVertical: 12, borderRadius: 8 },
