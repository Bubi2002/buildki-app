...
const styles = StyleSheet.create({
  ...
  saveBtn: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 0 },
  ...
  contentInput: { fontSize: 15, lineHeight: 22, padding: 16, borderRadius: 0, borderWidth: 1, minHeight: 200, marginBottom: 20 },
  tagSection: { marginBottom: 20 },
  tagLabel: { fontSize: 13, fontWeight: "500", marginBottom: 8 },
  tagInputRow: { flexDirection: "row", gap: 8 },
  tagInput: { flex: 1, fontSize: 14, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 0, borderWidth: 1 },
  tagAddBtn: { width: 40, height: 40, borderRadius: 0, alignItems: "center", justifyContent: "center" },
  tagList: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 10 },
  tag: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 0, borderWidth: 1 },
