...
const styles = StyleSheet.create({
  ...
  statsBar: { flexDirection: "row", justifyContent: "space-around", paddingVertical: 12, marginHorizontal: 16, marginTop: 8, borderRadius: 12 },
  statItem: { alignItems: "center" },
  statNumber: { fontSize: 20, fontWeight: "700" },
  statLabel: { fontSize: 11, marginTop: 2 },
  desktopColumns: { flex: 1, flexDirection: "row", padding: 16, gap: 12 },
  column: { flex: 1, borderWidth: 1, borderRadius: 12, overflow: "hidden" },
  ...
  taskCard: { padding: 12, borderRadius: 10, borderWidth: 0.5, marginBottom: 8 },
  ...
  moveButton: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 4, paddingVertical: 10, borderRadius: 8, borderWidth: 1.5 },
  moveButtonText: { fontSize: 12, fontWeight: "600" },
  goToProtocol: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, margin: 16, paddingVertical: 12, borderRadius: 10 },
