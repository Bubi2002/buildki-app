...
const styles = StyleSheet.create({
  ...
  addBtn: { padding: 8 },
  summaryCard: { flexDirection: "row", alignItems: "center", gap: 12, padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 16 },
  summaryText: { flex: 1 },
  summaryTitle: { fontSize: 16, fontWeight: "600" },
  summarySubtitle: { fontSize: 13, marginTop: 2 },
  list: { paddingBottom: 20 },
  entryCard: { padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 8 },
  entryHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  dateContainer: { flexDirection: "row", alignItems: "center", gap: 6 },
  entryDate: { fontSize: 15, fontWeight: "600" },
  autoBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  ...
  closeBtn: { paddingVertical: 14, borderRadius: 10, alignItems: "center", marginTop: 16 },
  ...
  timeInput: { flex: 1, borderWidth: 1, borderRadius: 10, padding: 10, fontSize: 14, textAlign: "center" },
