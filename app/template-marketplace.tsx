...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: "row", alignItems: "center", margin: 16, marginBottom: 8, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 10, borderWidth: 0.5, gap: 8 },
  searchInput: { flex: 1, fontSize: 14 },
  categoryScroll: { maxHeight: 44, marginBottom: 8 },
  categoryContent: { paddingHorizontal: 16, gap: 8 },
  categoryChip: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, borderWidth: 0.5 },
  categoryText: { fontSize: 12, fontWeight: "500" },
  list: { padding: 16, gap: 12 },
  templateCard: { padding: 14, borderRadius: 12, borderWidth: 0.5, gap: 8 },
  ...
  iconCircleLarge: { width: 56, height: 56, borderRadius: 28, alignItems: "center", justifyContent: "center" },
  metaInfo: { flex: 1, gap: 4 },
  metaAuthor: { fontSize: 13 },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  modalDesc: { fontSize: 14, lineHeight: 20, marginBottom: 16 },
  sectionTitle: { fontSize: 14, fontWeight: "600", marginBottom: 8 },
  promptPreview: { fontSize: 12, lineHeight: 18, padding: 12, borderRadius: 8, marginBottom: 12 },
  modalActions: { padding: 16, borderTopWidth: 0.5, borderTopColor: "#e5e7eb" },
  importButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 14, borderRadius: 10 },
